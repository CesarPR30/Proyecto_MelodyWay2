        ...
        >
            <div
                style={{
                    ...
                    borderRadius: '8px',
                    overflow: 'hidden',
                    boxShadow: '0 2px 8px 0 rgba(255,255,255,0.7)'
                }}
                    ...
                    if (node._type === 'person') {
                        ...
                        g.append('circle')
                            ...
                            .on('mousemove', (event) => {
                                ...
                                const influenceScore = node.totalInfluence ? (node.totalInfluence / 2).toFixed(2) : null;
                                tooltip
                                    .style('display', 'block')
                                    .html(
                                        ...
                                        (Array.isArray(node.roles) && node.roles.length
                                            ...
                                            : '') +
                                        (influenceScore !== null ? `<br/>Influence Score: ${influenceScore}` : '')
                                    )
                                    .style('left', (event.pageX + 12) + 'px')
                                    .style('top', (event.pageY - 24) + 'px');
                            })
                            ...
                            .on('click', (event) => {
                                ...
                                // Open lightbox for all artists
                                setIsLightboxOpen(true);
                                setLightboxUrl(`https://harmonious-cannoli-bc45fa.netlify.app/?personId=${node.id}`);
                            });
                    } else {
                        g.append('rect')
                                ...
                                {artistSearchResults.slice(0, 10).map(a => (
                                    <div
                                        ...
                                        onMouseDown={e => {
                                            ...
                                            // Open lightbox for all artists
                                            setIsLightboxOpen(true);
                                            setLightboxUrl(`https://harmonious-cannoli-bc45fa.netlify.app/?personId=${a.id}`);
                                        }}
                                        style={{
                                            padding: '6px 10px',
                                            cursor: 'pointer',
